...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000050f00e2b9f567ff478577267bc65b7bce0588a22b17393605eb9c4f3bc3"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1526771551, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 5520;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Tiercoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Tiercoin: 1 day
        nTargetSpacing = 1 * 60;  // Tiercoin: 1 minute
        nMaturity = 10;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "This is the testnet for POSQ TIered Masternodes";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1526771551;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 145774;
		
		
		hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000050f00e2b9f567ff478577267bc65b7bce0588a22b17393605eb9c4f3bc3"));
        assert(genesis.hashMerkleRoot == uint256("0x7b82490717d8cb6d1e6add40e7ba25d701e89734b0c4b1bb3047a3b7b3c80c80"));
...
printf("genesis.hashMerkleRoot = %s \n", genesis.hashMerkleRoot.ToString().c_str());
	   ...
	   */
		...
		vSeeds.push_back(CDNSSeedData("140.82.61.65", "140.82.61.65")); // Primary DNS Seeder
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1526771834;
        genesis.nNonce = 909297;

	    hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000e75a7358f0fc8284accbbca6345726c12d76d2c94cbac54c55681b913e0"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("9955.76.461.28", "207.14998.0.129"));         // Single node address
        vSeeds.push_back(CDNSSeedData("209.25810.240.94", "45.77.285439.30"));       // Single node address
        vSeeds.push_back(CDNSSeedData("45.77.176.204", "45.76.28226.204"));       // Single node address


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet tiercoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet tiercoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet tiercoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet tiercoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet tiercoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Tiercoin: 1 day
        nTargetSpacing = 1 * 60;        // Tiercoin: 1 minutes
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 51436;
        assert(hashGenesisBlock == uint256("0x7cd5b8547ad58c400e79e4cec9a1bea0cebc28d2b45b210f3d4bf504684face7"));
