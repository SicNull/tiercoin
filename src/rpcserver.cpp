...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Tiercoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Tiercoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Tiercoin features */
        {"tiercoin", "masternode", &masternode, true, true, false},
        {"tiercoin", "listmasternodes", &listmasternodes, true, true, false},
        {"tiercoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tiercoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tiercoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tiercoin", "masternodedebug", &masternodedebug, true, true, false},
        {"tiercoin", "startmasternode", &startmasternode, true, true, false},
        {"tiercoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tiercoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tiercoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tiercoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tiercoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tiercoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tiercoin", "mnbudget", &mnbudget, true, true, false},
        {"tiercoin", "preparebudget", &preparebudget, true, true, false},
        {"tiercoin", "submitbudget", &submitbudget, true, true, false},
        {"tiercoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tiercoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tiercoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tiercoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tiercoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tiercoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tiercoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tiercoin", "checkbudgets", &checkbudgets, true, true, false},
        {"tiercoin", "mnsync", &mnsync, true, true, false},
        {"tiercoin", "spork", &spork, true, true, false},
        {"tiercoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"tiercoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use tiercoind, or the -server option to tiercoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> tiercoin-cli " + methodname + " " + args + "\n";
}
