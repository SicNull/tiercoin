                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Tiercoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tiercoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tiercoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTIER"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tiercoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tiercoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tiercoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tiercoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tiercoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Tiercoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tiercoin Core help message to get a list with possible Tiercoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Tiercoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tiercoin network", "", count));
}
...
{
    QString strTitle = tr("Tiercoin Core"); // default title
