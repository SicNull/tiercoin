...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Tiercoin Core"),
     ...
     * override -datadir in the tiercoin.conf file in the default data directory
     * (to be consistent with tiercoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
