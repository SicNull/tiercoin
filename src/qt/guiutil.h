...
/** Utility functions used by the Tiercoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Tiercoin addresses in monospace font
...
// Parse "tiercoin:" URI into recipient object, return true on successful parsing
