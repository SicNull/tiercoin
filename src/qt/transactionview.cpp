                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Tier from zTier"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTier"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTier));
