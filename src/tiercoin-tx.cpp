...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Tiercoin Core tiercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tiercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tiercoin transaction") + "\n" +
                               "  tiercoin-tx [options] -create [commands]   " + _("Create hex-encoded tiercoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tiercoin transaction
