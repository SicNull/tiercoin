...
RESOURCES += src/qt/tiercoin.qrc src/qt/tiercoin_locale.qrc

TRANSLATIONS += src/qt/locale/tiercoin_bg.ts \
                src/qt/locale/tiercoin_de.ts \
                src/qt/locale/tiercoin_en.ts \
                src/qt/locale/tiercoin_es.ts \
                src/qt/locale/tiercoin_fi.ts \
                src/qt/locale/tiercoin_fr.ts \
                src/qt/locale/tiercoin_it.ts \
                src/qt/locale/tiercoin_ja.ts \
                src/qt/locale/tiercoin_pl.ts \
                src/qt/locale/tiercoin_pt.ts \
                src/qt/locale/tiercoin_ru.ts \
                src/qt/locale/tiercoin_sk.ts \
                src/qt/locale/tiercoin_sv.ts \
                src/qt/locale/tiercoin_vi.ts \
                src/qt/locale/tiercoin_zh_CN.ts \
                src/qt/locale/tiercoin_zh_TW.ts
