Contributing to Tiercoin Core
============================

The Tiercoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Tiercoin Core project, and is not to be
confused with overall Tiercoin Network Protocol consensus changes.

Whether a pull request is merged into Tiercoin Core rests with the project merge
...
Patches that change Tiercoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tiercoin consensus, it must have been
...
The project leader is the release manager for each Tiercoin Core release.
