...
In order to support loading of multiple wallets in tiercoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tiercoin.cpp.
...
Changes to tiercoin.cpp
----------------------
tiercoin.cpp is the entry point into tiercoin-qt, and as such, will require some minor modifications to provide hooks for
